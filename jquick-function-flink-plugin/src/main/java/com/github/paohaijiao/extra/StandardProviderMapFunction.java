...
/**
 * Flink MapFunction - 添加新列
 */
public class StandardProviderMapFunction<R> implements MapFunction<JQuickRow, JQuickRow>, Serializable {

    private static final long serialVersionUID = 1L;

    private final JQuickFlinkBaseStandardProvider<R> provider;

    public StandardProviderMapFunction(JQuickFlinkBaseStandardProvider<R> provider) {
